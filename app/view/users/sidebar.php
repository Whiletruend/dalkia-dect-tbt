        ...
        <div class="col-sm-2 flex-grow-sm-1 flex-shrink-1 flex-grow-0 pb-sm-0 pb-3">
            <div class="bg-light border rounded-3 p-3 h-100">
                <ul class="nav nav-pills flex-sm-column flex-row mb-auto justify-content-between text-truncate">
                    <li class="nav-item">
                        <a class="nav-link px-2 text-truncate <?= $this->currentPage == 'users_global' ? 'active' : '' ?>" aria-current="page" href="?action=users_global">
                            <i class="far fa-eye fs-6"></i>
                            <span class="d-none d-sm-inline">Vue d'ensemble</span>
                        </a>
                    </li>
                    <li>
                        <a class="nav-link px-2 text-truncate <?= $this->currentPage == 'users_create' ? 'active' : '' ?>" aria-current="page" href="?action=users_create">
                            <i class="fa fa-user-plus fs-6"></i>
                            <span class="d-none d-sm-inline">Créer un utilisateur</span>
                        </a>
                    </li>
                </ul>
            </div> 
